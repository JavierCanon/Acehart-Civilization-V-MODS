...
SELECT  'ART_DEF_UNIT_ATTACKHELI', --Type
...
SELECT ( 'ART_DEF_UNIT_MEMBER_ATTACKHELI' ), --Type
       Scale,
       ZOffset,
       Domain,
...
SELECT 'ART_DEF_UNIT_ATTACKHELI',
       'ART_DEF_UNIT_MEMBER_ATTACKHELI',
       1 --NumMembers
 ;
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_ATTACKHELI' ), --UnitMemberType, --TEXT    NOT NULL PRIMARY KEY,
    EnableActions                ,--TEXT,
    DisableActions               ,--TEXT,
    MoveRadius                   ,--FLOAT,
    ShortMoveRadius              ,--FLOAT,
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_ATTACKHELI'), --UnitMemberType ,--TEXT    NOT NULL,
    [Index]                    ,--INTEGER NOT NULL,
    SubIndex                   ,--INTEGER NOT NULL,
    ID                         ,--TEXT,
    VisKillStrengthMin         ,--FLOAT,
...
SELECT ( 'UNITCLASS_ATTACKHELI' ), --Type
       Description,
       MaxGlobalInstances,
       MaxTeamInstances,
       MaxPlayerInstances,
...
SELECT 
    ( 'UNIT_ATTACKHELI' ), --Type, --TEXT NOT NULL UNIQUE,
    ( 'TXT_KEY_UNIT_ATTACKHELI_DESCRIPTION' ), --Description, --TEXT,
    'TXT_KEY_UNIT_ATTACKHELI_CIVILOPEDIA'                  ,--TEXT,
    'TXT_KEY_UNIT_ATTACKHELI_STRATEGY'                     ,--TEXT,
    'TXT_KEY_UNIT_ATTACKHELI_HELP'                         ,--TEXT,
    Requirements                 ,--TEXT,
    ...
    7, --BaseSightRange               ,--INTEGER DEFAULT 2,
    ( 'UNITCLASS_ATTACKHELI' ), --Class, --TEXT DEFAULT NULL,
    Special                      ,--TEXT    DEFAULT NULL,
    Capture                      ,--TEXT    DEFAULT NULL,
    CombatClass                  ,--TEXT    DEFAULT NULL,
    Domain                       ,--TEXT    DEFAULT NULL,
    ...
    NoMaintenance                ,--BOOLEAN DEFAULT 0,
    Unhappiness                  ,--INTEGER DEFAULT 0,
    ( 'ART_DEF_UNIT_ATTACKHELI' ), --UnitArtInfo, --TEXT DEFAULT NULL,
    UnitArtInfoCulturalVariation ,--BOOLEAN DEFAULT 0,
    UnitArtInfoEraVariation      ,--BOOLEAN DEFAULT 0,
    ProjectPrereq                ,--TEXT    DEFAULT NULL,
    SpaceshipProject             ,--TEXT    DEFAULT NULL,
