...
SELECT  'ART_DEF_UNIT_HELISQUAD_II', --Type
 ...
 WHERE ( Type = 'ART_DEF_UNIT_PARATROOPER' )
 ;
...
SELECT ( 'ART_DEF_UNIT_MEMBER_HELISQUAD_II' ), --Type
       Scale,
       ZOffset,
       Domain,
...
SELECT 'ART_DEF_UNIT_HELISQUAD_II',
       'ART_DEF_UNIT_MEMBER_PARATROOPER',
       6 --NumMembers
UNION
SELECT 'ART_DEF_UNIT_HELISQUAD_II',
       'ART_DEF_UNIT_MEMBER_HELISQUAD_II',
       1 --NumMembers
 ;
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_HELISQUAD_II' ), --UnitMemberType, --TEXT    NOT NULL PRIMARY KEY,
    EnableActions                ,--TEXT,
    DisableActions               ,--TEXT,
    MoveRadius                   ,--FLOAT,
    ShortMoveRadius              ,--FLOAT,
 ...
 WHERE ( UnitMemberType = 'ART_DEF_UNIT_MEMBER_PARATROOPER' )
 ;
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_HELISQUAD_II'), --UnitMemberType ,--TEXT    NOT NULL,
    [Index]                    ,--INTEGER NOT NULL,
    SubIndex                   ,--INTEGER NOT NULL,
    ID                         ,--TEXT,
    VisKillStrengthMin         ,--FLOAT,
...
SELECT ( 'UNITCLASS_HELISQUAD_II' ), --Type
       Description,
       MaxGlobalInstances,
       MaxTeamInstances,
       MaxPlayerInstances,
...
SELECT 
    ...
    ( 'UNITCLASS_HELISQUAD_II' ), --Class, --TEXT DEFAULT NULL,
    Special                      ,--TEXT    DEFAULT NULL,
    Capture                      ,--TEXT    DEFAULT NULL,
    CombatClass                  ,--TEXT    DEFAULT NULL,
    Domain                       ,--TEXT    DEFAULT NULL,
    ...
    Suicide                      ,--BOOLEAN DEFAULT 0,
    CaptureWhileEmbarked         ,--BOOLEAN DEFAULT 0,
    'TECH_MOBILE_TACTICS', --PrereqTech, --TEXT    DEFAULT NULL,
    ObsoleteTech                 ,--TEXT    DEFAULT NULL,
    GoodyHutUpgradeUnitClass     ,--TEXT    DEFAULT NULL,
    HurryCostModifier            ,--INTEGER DEFAULT 0,
    AdvancedStartCost            ,--INTEGER DEFAULT 0,
    ...
    NoMaintenance                ,--BOOLEAN DEFAULT 0,
    Unhappiness                  ,--INTEGER DEFAULT 0,
    ( 'ART_DEF_UNIT_HELISQUAD_II' ), --UnitArtInfo, --TEXT DEFAULT NULL,
    UnitArtInfoCulturalVariation ,--BOOLEAN DEFAULT 0,
    UnitArtInfoEraVariation      ,--BOOLEAN DEFAULT 0,
    ProjectPrereq                ,--TEXT    DEFAULT NULL,
    SpaceshipProject             ,--TEXT    DEFAULT NULL,
