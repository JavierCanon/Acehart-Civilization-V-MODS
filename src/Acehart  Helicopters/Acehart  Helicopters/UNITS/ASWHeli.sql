...
SELECT  'ART_DEF_UNIT_ASWHELI', --Type
...
SELECT ( 'ART_DEF_UNIT_MEMBER_ASWHELI' ), --Type
       Scale,
       ZOffset,
       Domain,
       'eurotiger_nightblueTC.fxsxml', --Model
       MaterialTypeTag,
...
SELECT 'ART_DEF_UNIT_ASWHELI',
       'ART_DEF_UNIT_MEMBER_ASWHELI',
       1 --NumMembers
 ;
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_ASWHELI' ), --UnitMemberType, --TEXT    NOT NULL PRIMARY KEY,
    EnableActions                ,--TEXT,
    DisableActions               ,--TEXT,
    MoveRadius                   ,--FLOAT,
    ShortMoveRadius              ,--FLOAT,
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_ASWHELI'), --UnitMemberType ,--TEXT    NOT NULL,
    [Index]                    ,--INTEGER NOT NULL,
    SubIndex                   ,--INTEGER NOT NULL,
    ID                         ,--TEXT,
    VisKillStrengthMin         ,--FLOAT,
...
SELECT 
    ...
    NoMaintenance                ,--BOOLEAN DEFAULT 0,
    Unhappiness                  ,--INTEGER DEFAULT 0,
    ( 'ART_DEF_UNIT_ASWHELI' ), --UnitArtInfo, --TEXT DEFAULT NULL,
    UnitArtInfoCulturalVariation ,--BOOLEAN DEFAULT 0,
    UnitArtInfoEraVariation      ,--BOOLEAN DEFAULT 0,
    ProjectPrereq                ,--TEXT    DEFAULT NULL,
    SpaceshipProject             ,--TEXT    DEFAULT NULL,
