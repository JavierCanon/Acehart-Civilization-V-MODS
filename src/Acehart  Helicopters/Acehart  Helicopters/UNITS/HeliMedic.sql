...
SELECT  'ART_DEF_UNIT_HELIMEDIC', --Type
...
SELECT ( 'ART_DEF_UNIT_MEMBER_HELIMEDIC' ), --Type
       Scale,
       ZOffset,
       Domain,
...
SELECT 'ART_DEF_UNIT_HELIMEDIC',
       'ART_DEF_UNIT_MEMBER_MARINE',
       6 --NumMembers
UNION
SELECT 'ART_DEF_UNIT_HELIMEDIC',
       'ART_DEF_UNIT_MEMBER_HELIMEDIC',
       1 --NumMembers
 ;
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_HELIMEDIC' ), --UnitMemberType, --TEXT    NOT NULL PRIMARY KEY,
    EnableActions                ,--TEXT,
    DisableActions               ,--TEXT,
    MoveRadius                   ,--FLOAT,
    ShortMoveRadius              ,--FLOAT,
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_HELIMEDIC'), --UnitMemberType ,--TEXT    NOT NULL,
    [Index]                    ,--INTEGER NOT NULL,
    SubIndex                   ,--INTEGER NOT NULL,
    ID                         ,--TEXT,
    VisKillStrengthMin         ,--FLOAT,
...
SELECT ( 'UNITCLASS_HELIMEDIC' ), --Type
       Description,
       MaxGlobalInstances,
       MaxTeamInstances,
       MaxPlayerInstances,
...
SELECT 
    ...
    ( 'UNITCLASS_HELIMEDIC' ), --Class, --TEXT DEFAULT NULL,
    Special                      ,--TEXT    DEFAULT NULL,
    Capture                      ,--TEXT    DEFAULT NULL,
    CombatClass                  ,--TEXT    DEFAULT NULL,
    Domain                       ,--TEXT    DEFAULT NULL,
    ...
    NoMaintenance                ,--BOOLEAN DEFAULT 0,
    Unhappiness                  ,--INTEGER DEFAULT 0,
    ( 'ART_DEF_UNIT_HELIMEDIC' ), --UnitArtInfo, --TEXT DEFAULT NULL,
    UnitArtInfoCulturalVariation ,--BOOLEAN DEFAULT 0,
    UnitArtInfoEraVariation      ,--BOOLEAN DEFAULT 0,
    ProjectPrereq                ,--TEXT    DEFAULT NULL,
    SpaceshipProject             ,--TEXT    DEFAULT NULL,
