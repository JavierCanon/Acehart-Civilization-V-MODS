...
SELECT  'ART_DEF_UNIT_HELIMEDIC_II', --Type
...
SELECT ( 'ART_DEF_UNIT_MEMBER_HELIMEDIC_II' ), --Type
       Scale,
       ZOffset,
       Domain,
       'Gazelle_Medic.fxsxml', --Model
       MaterialTypeTag,
...
SELECT 'ART_DEF_UNIT_HELIMEDIC_II',
       'ART_DEF_UNIT_MEMBER_MARINE',
       6 --NumMembers
UNION
SELECT 'ART_DEF_UNIT_HELIMEDIC_II',
       'ART_DEF_UNIT_MEMBER_HELIMEDIC_II',
       1 --NumMembers
 ;
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_HELIMEDIC_II' ), --UnitMemberType, --TEXT    NOT NULL PRIMARY KEY,
    EnableActions                ,--TEXT,
    DisableActions               ,--TEXT,
    MoveRadius                   ,--FLOAT,
    ShortMoveRadius              ,--FLOAT,
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_HELIMEDIC_II'), --UnitMemberType ,--TEXT    NOT NULL,
    [Index]                    ,--INTEGER NOT NULL,
    SubIndex                   ,--INTEGER NOT NULL,
    ID                         ,--TEXT,
    VisKillStrengthMin         ,--FLOAT,
...
SELECT ( 'UNITCLASS_HELIMEDIC_II' ), --Type
       Description,
       MaxGlobalInstances,
       MaxTeamInstances,
       MaxPlayerInstances,
       InstanceCostModifier,
       'UNIT_HELIMEDIC_II' --DefaultUnit
  FROM UnitClasses
...
SELECT 
    ( 'UNIT_HELIMEDIC_II' ), --Type, --TEXT NOT NULL UNIQUE,
    ( 'TXT_KEY_UNIT_HELIMEDIC_II_DESCRIPTION' ), --Description, --TEXT,
    'TXT_KEY_UNIT_HELIMEDIC_II_CIVILOPEDIA'                  ,--TEXT,
    'TXT_KEY_UNIT_HELIMEDIC_II_STRATEGY'                     ,--TEXT,
    'TXT_KEY_UNIT_HELIMEDIC_II_HELP'                         ,--TEXT,
    Requirements                 ,--TEXT,
    ...
    ( 'UNITCLASS_HELIMEDIC_II' ), --Class, --TEXT DEFAULT NULL,
    Special                      ,--TEXT    DEFAULT NULL,
    Capture                      ,--TEXT    DEFAULT NULL,
    CombatClass                  ,--TEXT    DEFAULT NULL,
    Domain                       ,--TEXT    DEFAULT NULL,
    ...
    NoMaintenance                ,--BOOLEAN DEFAULT 0,
    Unhappiness                  ,--INTEGER DEFAULT 0,
    ( 'ART_DEF_UNIT_HELIMEDIC_II' ), --UnitArtInfo, --TEXT DEFAULT NULL,
    UnitArtInfoCulturalVariation ,--BOOLEAN DEFAULT 0,
    UnitArtInfoEraVariation      ,--BOOLEAN DEFAULT 0,
    ProjectPrereq                ,--TEXT    DEFAULT NULL,
    SpaceshipProject             ,--TEXT    DEFAULT NULL,
...
SELECT
           ...
           'TXT_KEY_UNIT_HELIMEDIC_II_DESCRIPTION' 
           ,'Medic Heli II'
UNION
SELECT

           'TXT_KEY_UNIT_HELIMEDIC_II_CIVILOPEDIA' 
           ,'Medic Heli II'
UNION
SELECT

           'TXT_KEY_UNIT_HELIMEDIC_II_STRATEGY' 
           ,'Medic Heli II'
UNION
SELECT

           'TXT_KEY_UNIT_HELIMEDIC_II_HELP' 
           ,'Medic Heli II'   
;
