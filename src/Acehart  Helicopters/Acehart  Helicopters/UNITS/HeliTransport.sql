...
SELECT  'ART_DEF_UNIT_HELITRANSPORT', --Type
...
SELECT ( 'ART_DEF_UNIT_MEMBER_HELITRANSPORT' ), --Type
       Scale,
       ZOffset,
       Domain,
       'Mi8PlainTeamColor.fxsxml', --Model
       MaterialTypeTag,
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_HELITRANSPORT' ), --UnitMemberType, --TEXT    NOT NULL PRIMARY KEY,
    EnableActions                ,--TEXT,
    DisableActions               ,--TEXT,
    MoveRadius                   ,--FLOAT,
    ShortMoveRadius              ,--FLOAT,
...
SELECT 
    ('ART_DEF_UNIT_MEMBER_HELITRANSPORT'), --UnitMemberType ,--TEXT    NOT NULL,
    [Index]                    ,--INTEGER NOT NULL,
    SubIndex                   ,--INTEGER NOT NULL,
    ID                         ,--TEXT,
    VisKillStrengthMin         ,--FLOAT,
...
SELECT ( 'UNITCLASS_HELITRANSPORT' ), --Type
       Description,
       MaxGlobalInstances,
       MaxTeamInstances,
       MaxPlayerInstances,
...
SELECT 
    ...
    NoMaintenance                ,--BOOLEAN DEFAULT 0,
    Unhappiness                  ,--INTEGER DEFAULT 0,
    ( 'ART_DEF_UNIT_HELITRANSPORT' ), --UnitArtInfo, --TEXT DEFAULT NULL,
    UnitArtInfoCulturalVariation ,--BOOLEAN DEFAULT 0,
    UnitArtInfoEraVariation      ,--BOOLEAN DEFAULT 0,
    ProjectPrereq                ,--TEXT    DEFAULT NULL,
    SpaceshipProject             ,--TEXT    DEFAULT NULL,
